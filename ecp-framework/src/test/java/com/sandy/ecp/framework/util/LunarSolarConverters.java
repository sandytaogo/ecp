...
public class LunarSolarConverters {
	...
	public static void main(String[] args) {
		...
		Lunar lunar = LunarSolarConverters.SolarToLunar(solar);
		System.out.println(dump(lunar));
		solar = LunarSolarConverters.LunarToSolar(lunar);
		System.out.println(dump(solar));
		System.out.println(LunarSolarConverters.lunarYearToGanZhi(2015));
	}
}
