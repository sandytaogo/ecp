...
public class RDN {
    ...
    public RDN(String var1, String var2) throws IOException {
    ...
    public RDN(DerValue var1) throws IOException {
        if (var1.tag != 49) {
    ...
    public DerValue findAttribute(ObjectIdentifier var1) {
        for(int var2 = 0; var2 < this.assertion.length; ++var2) {
