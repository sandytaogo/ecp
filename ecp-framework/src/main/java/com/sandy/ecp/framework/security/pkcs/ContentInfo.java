...
public class ContentInfo {
    ...
    public ContentInfo(DerInputStream var1, boolean var2) throws IOException, ParsingException {
        ...
        if (var7.length >= 1 && var7.length <= 2) {
    ...
    static {
        PKCS7_OID = ObjectIdentifier.of(KnownOIDs.PKCS7);
        DATA_OID = ObjectIdentifier.of(KnownOIDs.Data);
        SIGNED_DATA_OID = ObjectIdentifier.of(KnownOIDs.SignedData);
        ENVELOPED_DATA_OID = ObjectIdentifier.of(KnownOIDs.EnvelopedData);
        SIGNED_AND_ENVELOPED_DATA_OID = ObjectIdentifier.of(KnownOIDs.SignedAndEnvelopedData);
        DIGESTED_DATA_OID = ObjectIdentifier.of(KnownOIDs.DigestedData);
        ENCRYPTED_DATA_OID = ObjectIdentifier.of(KnownOIDs.EncryptedData);
        OLD_SIGNED_DATA_OID = ObjectIdentifier.of(KnownOIDs.JDK_OLD_SignedData);
        OLD_DATA_OID = ObjectIdentifier.of(KnownOIDs.JDK_OLD_Data);
        NETSCAPE_CERT_SEQUENCE_OID = ObjectIdentifier.of(KnownOIDs.NETSCAPE_CertSequence);
        TIMESTAMP_TOKEN_INFO_OID = ObjectIdentifier.of(KnownOIDs.TimeStampTokenInfo);
    }
}
