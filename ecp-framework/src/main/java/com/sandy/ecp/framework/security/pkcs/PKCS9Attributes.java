...
public class PKCS9Attributes {
    ...
    public PKCS9Attribute[] getAttributes() {
        ...
        for(int var3 = 1; var3 < PKCS9Attribute.PKCS9_OIDS.length && var2 < var1.length; ++var3) {
            if (PKCS9Attribute.PKCS9_OIDS[var3] != null) {
                var1[var2] = this.getAttribute(PKCS9Attribute.PKCS9_OIDS[var3]);
                if (var1[var2] != null) {
                    ++var2;
                }
            }
    ...
    public String toString() {
        ...
        for(int var4 = 1; var4 < PKCS9Attribute.PKCS9_OIDS.length; ++var4) {
            if (PKCS9Attribute.PKCS9_OIDS[var4] != null) {
                PKCS9Attribute var2 = this.getAttribute(PKCS9Attribute.PKCS9_OIDS[var4]);
                if (var2 != null) {
                    if (var3) {
                        var3 = false;
                    } else {
