...
public class AVA implements DerEncoder {
	...
	private DerValue parseQuotedString(Reader var1, StringBuilder var2) throws IOException {
		...
		while (true) {
			...
			if (!this.oid.equals(PKCS9Attribute.EMAIL_ADDRESS_OID)
					&& (!this.oid.equals(X500Name.DOMAIN_COMPONENT_OID) || PRESERVE_OLD_DC_ENCODING)) {
				if (var5) {
					...
					if (var2 == 32) {
						if (!var8 && !trailingSpace(var1)) {
							throw new IOException(
									"Invalid escaped space character in AVA.  Only a leading or trailing space character can be escaped.");
						}
					} else if (var2 == 35) {
						if (!var8) {
							throw new IOException(
	...
	public void derEncode(OutputStream var1) throws IOException {
		...
		try (DerOutputStream var3 = new DerOutputStream()) {
	...
	public String toRFC2253String(Map<String, String> var1) {
		...
		if ((var2.charAt(0) < '0' || var2.charAt(0) > '9') && isDerString(this.value, false)) {
			...
			for (int var6 = 0; var6 < var3.length(); ++var6) {
				...
				if (!DerValue.isPrintableStringChar((char) var7) && ",=+<>#;\"\\".indexOf(var7) < 0) {
					if (var7 == 0) {
						var15.append("\\00");
						...
						byte[] var17;
						try {
							var17 = Character.toString((char) var7).getBytes("UTF8");
						...
						for (var9 = 0; var9 < var17.length; ++var9) {
							var15.append('\\');
							var10 = Character.forDigit(15 & var17[var9] >>> 4, 16);
							var15.append(Character.toUpperCase(var10));
							var10 = Character.forDigit(15 & var17[var9], 16);
							var15.append(Character.toUpperCase(var10));
						}
					} else {
			...
			for (var7 = 0; var7 < var16.length && (var16[var7] == ' ' || var16[var7] == '\r'); ++var7) {
			}

			int var18;
			for (var18 = var16.length - 1; var18 >= 0 && (var16[var18] == ' ' || var16[var18] == '\r'); --var18) {
			}

			for (var9 = 0; var9 < var16.length; ++var9) {
				var10 = var16[var9];
				if (var9 < var7 || var9 > var18) {
					var15.append('\\');
				}
