...
import com.sandy.ecp.mybatis.plugin.MapperRefresh;
/**
...
public class EcpSqlSessionFactoryBean implements FactoryBean, InitializingBean, ApplicationListener {

	private static final Log LOGGER = LogFactory.getLog(EcpSqlSessionFactoryBean.class);
	...
	private String environment = EcpSqlSessionFactoryBean.class.getSimpleName();
...
//issue #19. No default provider.
	...
	*/
	 ...
	 * for. The {@code DataSource}
	 * should match the one used by the {@code SqlSessionFactory}: for example, you
	 ...
	 * with
	 * {@code TransactionAwareDataSourceProxy}, while the transaction manager needs
	 * to work on the
	 ...
	 * It is strongly recommended to use the default {@code TransactionFactory}. If
	 * not used, any
	...
	/**
	 * NOTE: This class overrides any {@code Environment} you have set in the
	 * MyBatis
