...
import com.sandy.ecp.recognition.util.FileUtil;
import com.sandy.ecp.recognition.util.GenerateId;
...
public class CascadeTrain {
    ...
    public static void preparePosSamples(String sourcePath, String targetPath, Integer limit) {
        ...
        for (String img : files) {
            ...
            for (Rect rect : faceDetections.toArray()) {
                ...
                // 保存文件
                Imgcodecs.imwrite(targetPath + GenerateId.getId() + ".jpg", resized);
                i++;
                if(i >= limit) {
                    return;
                }
    ...
    public static void prepareNegSamples(String sourcePath, String targetPath, Integer limit) {
        ...
        for (String img : files) {
            ...
            // 保存文件
            Imgcodecs.imwrite(targetPath + GenerateId.getId() + ".jpg", negMat);
            i++;
            if(i >= limit) {
                return;
            }
